...
exports.abrirProgDoc = function (req, res, next) {
    ...
    let identificador = 'PD_' + plan + '_' + ano + '_' + tipoPD + '_v1'
    let pds = [];
    let nuevaPd = {};
    let s1 = false;
    let s2 = false;
    ...
    client.get("https://www.upm.es/wapi_upm/academico/comun/index.upm/v2/plan.json/" + plan + "/asignaturas?anio=" + ano, function (apiAsignaturas, response) {
        ...
        models.ProgramacionDocente.findAll({
            ...
            for (let i = 0; i < pds.length; i++) {
                ...
                if (ident[0] === 'PD' && ident[1] === plan && ident[2] === ano && ident[3] === tipoPD) {
                    ...
                    identificador = 'PD_' + plan + '_' + ano + '_' + tipoPD + '_v' + vers;
                }
            }
            nuevaPd.identificador = identificador;
            nuevaPd.version = Number(identificador.split("_")[4].split("v")[1]);
            nuevaPd.anoAcademico = ano;
            nuevaPd.semestre = tipoPD;
            nuevaPd.estadoProGDoc = -1;
            nuevaPd.fechaProgDoc = new Date();
            nuevaPd.fechaGrupos = new Date();
            nuevaPd.fechaProfesores = new Date();
            nuevaPd.fechaTribunales = new Date();
            nuevaPd.estadoHorarios = 1;
            nuevaPd.fechaHorarios = new Date();
            nuevaPd.estadoExamenes = 1;
            nuevaPd.fechaExamenes = new Date();
            nuevaPd.estadoCalendario = 1;
            nuevaPd.fechaCalendario = new Date();
                ...
                .then(() => { // Notice: There are no arguments here, as of right now you'll have to...
                    ...
                    return models.sequelize.query(query = 'SELECT distinct  "nombre", g."grupoId", "curso", "capacidad", "aula", "idioma" FROM public."Grupos" g  WHERE (g."ProgramacionDocenteId" = :pdId1 or g."ProgramacionDocenteId" = :pdId2) and g."nombre" LIKE :cursoGrupo  ORDER BY g."nombre" ASC ',
                        ...
                        grupos[0].forEach(function (g) {
                            ...
                            newGrupo.ProgramacionDocenteId = identificador;
                        ...
                        return models.Grupo.bulkCreate(
                           ...
                           return models.Grupo.findAll({
                                ...
                                where: {
                                    ProgramacionDocenteId: identificador
                                },
                                raw: true
                                ...
                                return models.Asignatura.findAll({
                                    ...
                                    if (apiAsignaturas[asignBBDD.codigo] && !nuevaAsignatura && !viejaAsignatura && !cambioAsignatura) {
                                        ...
                                        As.ProgramacionDocenteIdentificador = identificador;
                                                ...
                                                relacionGrupos.forEach(function (element, index) {
                                                    ...
                                                    if (element.curso === Number(asignBBDD.curso)) {
                                                        ...
                                                        if (asignacion.ProfesorId  && primerGrupo) {
                                                            ...
                                                            asignacion.GrupoId = element.identificadorNuevo;
                                                            console.log(asignacion.ProfesorId)
                                    ...
                                    for (let apiCodigo in apiAsignaturas) {
                                        let apiAsign = apiAsignaturas[apiCodigo];
                                        let asignExisteBBDD = asignaturasBBDD.find(function (obj) { return obj.codigo === apiAsign.codigo; });
                                        let semestre = ""
                                        let imparticion = apiAsign["imparticion"];
                                        if (imparticion['1S'] && imparticion['2S']) {
                                            semestre = "1S-2S"
                                        } else if (imparticion['1S']) {
                                            semestre = "1S"
                                        ...
                                        let apiDepartamentos = apiAsign['departamentos']
                                        ...
                                        if (!asignExisteBBDD && apiAsign['curso'] !== "" && semestre !== "" && (tipoPD === "I" || (tipoPD === '1S' && semestre !== '2S') || (tipoPD === '2S' && semestre !== '1S')) ) {
                                            let nuevaAsign = {};
                                            nuevaAsign.anoAcademico = ano;
                                            nuevaAsign.codigo = apiAsign.codigo;
                                            nuevaAsign.nombre = apiAsign.nombre;
                                            nuevaAsign.nombreIngles = apiAsign["nombre_ingles"];
                                            nuevaAsign.curso = apiAsign['curso'];
                                            nuevaAsign.semestre = semestre;
                                            nuevaAsign.DepartamentoResponsable = depResponsable;
                                            nuevaAsign.estado = "S";
                                            nuevaAsign.creditos = apiAsign['credects'];
                                            nuevaAsign.ProgramacionDocenteIdentificador = identificador;
                                            switch (apiAsign["codigo_tipo_asignatura"]) {
                                                case "T":
                                                    nuevaAsign.tipo = 'bas';
                                                    break;
                                                case "B":
                                    ...
                                    return models.Asignatura.bulkCreate(
                                        ...
                                        return models.Asignatura.findAll({
                                            ...
                                            where: {
                                                ProgramacionDocenteIdentificador: identificador
                                            },
                                            raw: true
                                            ...
                                            let index = departamentosResponsables.indexOf(asignaturaNueva.DepartamentoResponsable)
                                            if (index < 0 && asignaturaNueva.DepartamentoResponsable){
                                                departamentosResponsables.push(asignaturaNueva.DepartamentoResponsable)
                                            }
